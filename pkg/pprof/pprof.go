...
import (
	...
	grafanapprof "github.com/grafana/pyroscope-go/godeltaprof/http/pprof"
...
func RouteRegister(rg gin.IRouter, prefixOptions ...string) {
	...
	prefixRouter := rg.Group(prefix)
	{
		...
		prefixRouter.GET("/delta_heap", gin.WrapF(grafanapprof.Heap))
		prefixRouter.GET("/delta_block", gin.WrapF(grafanapprof.Block))
		prefixRouter.GET("/delta_mutex", gin.WrapF(grafanapprof.Mutex))
	}
}
